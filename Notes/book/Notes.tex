...
\hypertarget{making-cools-tables-in-rmarkdown-from-r-code}{%
\subsection{Making cools tables in Rmarkdown from R code}\label{making-cools-tables-in-rmarkdown-from-r-code}}
...
\hypertarget{a-kable-table}{%
\subsubsection{A kable table}\label{a-kable-table}}
...
\hypertarget{a-dt-table}{%
\subsubsection{A DT table}\label{a-dt-table}}
...
\hypertarget{dt-table-with-download-options}{%
\subsubsection{DT table with download options}\label{dt-table-with-download-options}}
...
\NormalTok{p }\OperatorTok{\{}
  \DataTypeTok{color}\OperatorTok{:}\NormalTok{ red}\OperatorTok{;}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{m_to_q<-}\ControlFlowTok{function}\NormalTok{(dataframe)}
\NormalTok{\{}
 \ControlFlowTok{if}\NormalTok{(}\StringTok{"Month"} \OperatorTok{%in%}\StringTok{ }\KeywordTok{colnames}\NormalTok{(dataframe) )\{}
\NormalTok{dataframe <-}\StringTok{ }\NormalTok{dataframe }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{Quarter =} \KeywordTok{case_when}\NormalTok{(}
    \KeywordTok{as.numeric}\NormalTok{(Month) }\OperatorTok{<=}\StringTok{ }\DecValTok{3} \OperatorTok{~}\StringTok{ "Q1"}\NormalTok{,}
    \KeywordTok{as.numeric}\NormalTok{(Month) }\OperatorTok{<=}\StringTok{ }\DecValTok{6} \OperatorTok{~}\StringTok{ "Q2"}\NormalTok{,}
    \KeywordTok{as.numeric}\NormalTok{(Month) }\OperatorTok{<=}\StringTok{ }\DecValTok{9} \OperatorTok{~}\StringTok{ "Q3"}\NormalTok{,}
    \OtherTok{TRUE}                   \OperatorTok{~}\StringTok{ "Q4"}
\NormalTok{  ))\} }\ControlFlowTok{else} \KeywordTok{stop}\NormalTok{(}\StringTok{"Column Month not found"}\NormalTok{)}
